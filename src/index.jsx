            ...
            <Folder current={this.state.page}>
              ...
              <Page page="settings">
                ...
                />
                    ...
                    <Page page="bellschedule"><iframe src="https://drive.google.com/file/d/1l2a5K4aW6r43224pAXtk6uirjbs4HKG1/view?usp=sharing" style={{ height:"95vh", width:"100%", margin:"0", border:"0", display:"block" }}></iframe> </Page>
