export default {
  title: "Finals Week - First and Sixth Period Finals",
  version: "2.1",
  lunches: [
    {id: "A", name: "A Lunch"},
    {id: "B", name: "B Lunch"},
  ...
  getTimes: function(l) {
    ...
    return [
      { name: "1st Period Exam", time: ["07:15", "08:45"] },
      { name: "6th Period Exam Exam", time: ["08:51", "10:19"] },
      ...lunches[l],
      { name: "7th Period", time: ["13:18", "14:40"] }
    ];
  }
};
