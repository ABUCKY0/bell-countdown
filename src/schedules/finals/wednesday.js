export default {
  title: "Finals Week - Third and Fourth Period Finals",
  version: "2.1",
  lunches: [
    {id: "A", name: "A Lunch"},
    {id: "B", name: "B Lunch"},
  ...
  getTimes: function(l) {
    ...
    return [
      { name: "Third Period Exam", time: ["07:15", "08:45"] },
      { name: "Fourth Period Exam", time: ["08:51", "10:19"] },
      ...lunches[l],
      { name: "6th Period", time: ["13:18", "14:40"] }
    ];
  }
};
